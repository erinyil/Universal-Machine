...
#
#     Author: Erin Yilmaz, Gustavo Curioso
#
#  Maintenance targets:
#
#
...
LDLIBS = -lbitpack -lcii40 -lm -lum-dis -lcii
...
#    executable.
#
um: um.o main.o instructions.o
	$(CC) $(LDFLAGS) -o um main.o um.o instructions.o $(LDLIBS)
